...
/// A [`Dialect`] for FunctionStream
/// This is based on the Postgres dialect
///
/// Currently the FunctionStream dialect differs from postgres in one respect: it supports
/// Hive/Biquery/etc. struct syntax (`struct<a INT, b TEXT>`)
#[derive(Debug)]
pub struct FunctionStreamDialect {}
...
impl Dialect for FunctionStreamDialect {
    ...
    // functionstream-specific features
